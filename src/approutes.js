  ...
  return (
    <Routes>
      ...
      <Route path="/" element={<Layout />}>
        ...
        <Route path="payment/:subscriptionId" element={<ProtectedRoute requiredRole={["EMPLOYER", "JOB_SEEKER"]}><PremiumCheckRoute><PaymentPage /></PremiumCheckRoute></ProtectedRoute>} />
